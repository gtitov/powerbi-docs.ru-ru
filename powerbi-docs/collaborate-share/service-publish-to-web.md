...
Во избежание интенсивного использования ограничьте количество отдельных запросов, которые может создать отчет, и частоту обновления данных. Ознакомьтесь с [руководством по оптимизации Power BI](../guidance/power-bi-optimization.md), в котором представлены советы по оптимизации отчетов.

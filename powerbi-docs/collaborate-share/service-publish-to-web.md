...
При внесении изменений в диалоговом окне обязательно скопируйте обновленный URL-адрес или iFrame, чтобы использовать обновленные параметры на странице.
...
### <a name="heavy-usage"></a>Интенсивное использование
...
Во избежание интенсивного использования ограничьте количество отдельных запросов, которые может создать отчет, и частоту обновления данных.

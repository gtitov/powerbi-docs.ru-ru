...
- Если в организации используются [приватные каналы](../admin/service-security-private-links.md), современные отчеты о метриках использования будут содержать частичные данные (только для представлений отчетов). Текущее ограничение при передаче сведений о клиентах по приватным каналам запрещает собирать данные представлений страниц отчетов и данные о производительности по приватным каналам. 

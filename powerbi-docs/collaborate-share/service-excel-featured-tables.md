---
title: Доступ к рекомендуемым таблицам Power BI в Excel
description: В Excel можно использовать данные из рекомендуемых таблиц в наборах данных Power BI в коллекции "Типы данных" организации.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: lukaszp
ms.service: powerbi
...
ms.locfileid: "96907056"
---
# <a name="access-power-bi-featured-tables-in-excel-organization-data-types"></a>Доступ к рекомендуемым таблицам Power BI в Excel в коллекции "Типы данных" организации
...
Если вы видите таблицу, которую ищете, выберите ее. В противном случае щелкните **Еще из вашей организации**. В Excel отображаются все рекомендуемые таблицы, к которым у вас есть доступ на панели.
...
В Excel отображаются все рекомендуемые таблицы, к которым у вас есть доступ. В области **Выбор данных** заполните поле **Фильтр**, чтобы уточнить параметры. Выберите таблицу, которую необходимо использовать.
...
Коллекция "Типы данных" Excel и подключенные функциональные возможности для рекомендуемых таблиц Power BI доступны только для подписчиков Excel с планом обслуживания Power BI Pro. 

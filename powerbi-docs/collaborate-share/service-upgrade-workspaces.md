...
>[!NOTE]
>Обновление рабочей области может инициировать администратор Power BI. Администраторы рабочих областей получают соответствующее сообщение электронной почты, когда их рабочая область обновляется администратором Power BI. [Дополнительные сведения](../admin/service-admin-portal.md#workspaces) 
...
- Администраторы Power BI могут инициировать обновление рабочей области. Администраторы рабочих областей получают соответствующее сообщение электронной почты, когда их рабочая область обновляется администратором Power BI.
...
Организации, желающие заранее перейти на новую рабочую область, могут сделать это на портале администрирования Power BI. Администратор Power BI может выбрать одну или несколько рабочих областей для обновления. В отношении обновлений рабочих областей, инициированных администратором Power BI, применяются те же рекомендации и ограничения, что и для обновлений рабочих областей, инициированных администратором рабочей области. [Подробнее](../admin/service-admin-portal.md#workspaces) 

Организациям, желающим управлять подобным процессом, рекомендуется выполнить следующие действия, чтобы предоставить администраторам рабочих областей соответствующие сведения.
...
2. Обратитесь к отдельным владельцам групп или администратору в Microsoft 365, чтобы сообщить им о планах обновить классические рабочие области.

Функция обновления рабочей области не предоставляет средства для программного обновления. Кроме того, новые группы Microsoft 365, созданные в вашей организации, будут по-прежнему отображаться в Power BI.
...
* [Запуск обновления рабочей области, инициированной администратором Power BI](../admin/service-admin-portal.md#workspaces)

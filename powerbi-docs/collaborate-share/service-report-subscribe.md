...
- Функция вложения полного отчета доступна для отчетов, отвечающих следующим трем условиям:
    ...
    :::image type="content" source="media/service-report-subscribe/full-report-attachment-error-email.png" alt-text="Письмо со сведениями об ошибке вложения полного отчета.":::

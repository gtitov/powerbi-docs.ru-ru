...
- [Совместная работа с коллегами в *рабочих областях*](#collaborate-in-a-workspace)для создания полноценных отчетов и панелей мониторинга.
- [Совместная работа в *Microsoft Teams*](#collaborate-in-microsoft-teams).

**Предоставление общего доступа к панелям мониторинга и отчетам**

- [*Предоставление доступа к панелям мониторинга или отчетам*](#share-dashboards-and-reports) другим пользователям из рабочей области My Workspace или из другой области.
- Добавление заметок и [предоставление общего доступа из *мобильных приложений Power BI*](#annotate-and-share-from-the-power-bi-mobile-apps).
- Объединение панелей мониторинга и отчетов из рабочих областей в *приложениях* и [предоставление их](#distribute-insights-in-an-app) большей группе пользователей или всей организации.
- [Внедрение отчетов](#embed-reports-in-secure-portals-or-public-web-sites) на *защищенных порталах* или *общедоступных веб-сайтах*.
- [Печать отчетов](#print-or-save-as-pdf-or-other-static-file).
- [Создание *приложения-шаблона*](#create-and-deploy-template-apps), которое можно распространять среди внешних пользователей Power BI с помощью Microsoft AppSource.
 
**Предоставление общего доступа к данным**

- [Создание *общих наборов данных*](#share-a-dataset), которые ваши коллеги могут использовать в качестве основы для собственных отчетов в своих рабочих областях.
- [Создание *потоков данных*](#create-dataflows) в качестве способа предоставления общего доступа к общему источнику.
...
Предположим, у вас есть отчет в Power BI Desktop и хотите предоставить другим пользователям доступ к нему. Один из способов — *предоставить общий доступ* к нему в службе Power BI. Вы публикуете его в разделе "Моя рабочая область" или в другой рабочей области. Возможно, вы создали панель мониторинга и готовы к работе с ней.
...
*Потоки данных* — это способ самостоятельного объединения данных из разнородных источников и подготовки их к моделированию. Аналитики создают потоки данных для приема, преобразования, интеграции и обогащения больших данных. Они создают потоки данных и управляют ими в рабочих областях в службе Power BI. Ознакомьтесь со сведениями о [самостоятельной подготовке данных с помощью потоков данных](../transform-model/dataflows/dataflows-introduction-self-service.md).

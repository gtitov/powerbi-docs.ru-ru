...
[Курс включает 25 видеороликов](https://www.youtube.com/playlist?list=PL1N57mwBHtN1icIhpjQOaRL8r9G-wytpT) и состоит из восьми модулей. Видеоролики рекомендуется смотреть в той последовательности, в которой они записаны, начиная с видео 01 и заканчивая видео 25.
...
- **Модуль 08. Дополнительные материалы**
  ...
  - Видео 25. [Дополнительные материалы: обновление за декабрь 2020 г. (2.88.321.0)](https://www.youtube.com/watch?v=-7M4muS_3BI&list=PL1N57mwBHtN1icIhpjQOaRL8r9G-wytpT)
...
>
> Некоторые задачи предполагают публикацию отчета с разбивкой на страницы в рабочей области. Отчет с разбивкой на страницы можно открыть, только если он сохраняется в рабочую область в [емкости](../admin/service-premium-what-is.md#reserved-capacities) с включенной рабочей нагрузкой отчетов с разбивкой на страницы. Если у вас нет доступа к подходящей рабочей области, в рамках занятия вам будет предоставлена ссылка для просмотра видео, в котором показана публикация отчета.

...
>
> Некоторые задачи предполагают публикацию отчета с разбивкой на страницы в рабочей области. Отчет с разбивкой на страницы можно открыть, только если он сохраняется в рабочую область в [емкости](../admin/service-premium-what-is.md#dedicated-capacities) с включенной рабочей нагрузкой отчетов с разбивкой на страницы. Если у вас нет доступа к подходящей рабочей области, в рамках занятия вам будет предоставлена ссылка для просмотра видео, в котором показана публикация отчета.

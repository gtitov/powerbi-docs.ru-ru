...
- На вкладке **Главная** ленты в разделе **Запросы** выберите **Преобразовать данные**.

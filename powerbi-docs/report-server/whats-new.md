...
ms.locfileid: "93132420"
---
# <a name="whats-new-in-power-bi-report-server"></a>Новые возможности сервера отчетов Power BI

Узнайте о возможностях новых версий Сервера отчетов Power BI и оптимизированной для Сервера отчетов версии Power BI Desktop. В этой статье приводятся сведения об основных функциях. Материалы обновляются по мере появления новых выпусков. Дополнительные сведения о новых возможностях Сервера отчетов Power BI см. в статье [Журнал изменений для Сервера отчетов Power BI](changelog.md).
...
В Power BI Desktop, оптимизированном для Сервера отчетов Power BI, появилась современная лента. Мы будем вносить дополнения и добавлять функции для этой ленты. Дополнительные сведения об изменениях и преимуществах см. в разделе [Использование обновленной ленты в Power BI Desktop](../create-reports/desktop-ribbon.md).

:::image type="content" source="media/whats-new/report-server-new-ribbon.png" alt-text="Снимок экрана: новая лента в Power BI Desktop, оптимизированном для Сервера отчетов Power BI":::
...
:::image type="content" source="media/whats-new/report-server-slicer-hierarchy.png" alt-text="Иерархический срез в Power BI Desktop, оптимизированном для Сервера отчетов Power BI":::
...
:::image type="content" source="media/whats-new/report-server-mobile-layout.png" alt-text="Расширенный мобильный макет в Power BI Desktop, оптимизированном для Сервера отчетов Power BI":::
...
:::image type="content" source="media/whats-new/report-server-excel-table.png" alt-text="Распознавание таблицы Excel в Power BI Desktop, оптимизированном для Сервера отчетов Power BI":::
...
Если у вас имеется более старый PBIX-файл, который не может быть обновлен автоматически по таким причинам, как непримененные изменения, необходимо успешно обновить модель, прежде чем можно будет вносить дополнительные изменения в моделирование. 
...
Ниже приведен полный список обновлений в октябрьском выпуске Power BI Desktop, оптимизированного для Сервера отчетов Power BI. 

...
:::image type="content" source="media/desktop-relationships-understand/data-island-example.png" alt-text="Пример составной модели из двух островов.":::
...
На примере ниже показаны две обычные связи, помеченные как **R**. Отношения включают в себя связь "одна ко многим", содержащуюся на острове Vertipaq, и связь "одна ко многим", содержащуюся в источнике DirectQuery.

:::image type="content" source="media/desktop-relationships-understand/data-island-example-regular.png" alt-text="Пример составной модели из двух островов, где отмечены обычные связи.":::
...
На примере ниже показаны две ограниченные связи, помеченные как **L**. Два отношения включают в себя связь "много ко многим", содержащуюся на острове Vertipaq, и межостровую связь "одна ко многим".

:::image type="content" source="media/desktop-relationships-understand/data-island-example-limited.png" alt-text="Пример составной модели из двух островов, где отмечены ограниченные связи.":::

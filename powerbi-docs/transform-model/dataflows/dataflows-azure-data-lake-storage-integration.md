...
Учетная запись хранения должна быть создана с включенным [иерархическим пространством имен (HNS)](/azure/storage/blobs/create-data-lake-storage-account). 

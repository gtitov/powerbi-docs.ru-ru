...
По умолчанию расширенное ядро вычислений **включено**. Если расширенное ядро вычислений не включено, следуйте инструкциям в следующем разделе и ознакомьтесь с ответами на часто задаваемые вопросы.
...
При настройке добавочного обновления в поток данных добавляются параметры для указания диапазона дат. Подробные сведения о настройке добавочного обновления см. в статье о [добавочном обновлении](/power-query/dataflows/incremental-refresh).
...
* [Настройка рабочих нагрузок потока данных Power BI Premium](dataflows-premium-workload-configuration.md)

...
2. Убедитесь, что выполняете операции, которые могут свертываться, например слияние, объединение, преобразование и [другие](https://docs.microsoft.com/power-query/power-query-folding#transformations-that-can-achieve-folding).

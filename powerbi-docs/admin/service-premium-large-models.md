...
ms.locfileid: "96781717"
---
# <a name="large-datasets-in-power-bi-premium"></a>Большие наборы данных в Power BI Premium

Наборы данных Power BI могут хранить данные в кэше в памяти с высоким уровнем сжатия для оптимизации производительности запросов, что позволяет поддерживать быстрое взаимодействие с пользователем. При использовании емкости уровня Premium большие наборы данных, превышающие ограничение по умолчанию (10 ГБ), можно включить с помощью параметра **Формат хранения большого набора данных**. Если этот параметр включен, размер набора данных ограничен *емкостью* Premium.
...
Большие наборы данных в службе не влияют на размер отправки модели Power BI Desktop, который по-прежнему ограничен 10 ГБ. Вместо этого при обновлении службы наборы данных может превысить ограничение в 10 ГБ.

...
Действия, которые может выполнять пользователь в службе Power BI, зависят от типа имеющейся у пользователя лицензии. Уровень доступа, предоставляемый лицензией, зависит от того, имеет рабочая область уровень Premium или нет. У каждого пользователя службы Power BI должна быть лицензия.

Получить лицензии для пользователей можно двумя способами. Пользователь может получить бесплатную лицензию, лицензию Pro или Premium на пользователя самостоятельно, используя возможности самостоятельной регистрации и свою рабочую или учебную учетную запись. Администраторы могут получить лицензию Power BI и назначить лицензии пользователям.
...
Отдельные пользователи могут получать лицензии Power BI, регистрируясь с помощью своих рабочих или учебных учетных записей. С бесплатной лицензией пользователь может использовать Power BI для анализа и визуализации личных данных в разделе "Моя рабочая область", но не может поделиться ей с другими пользователями. Для совместного использования содержимого требуется лицензия Power BI Pro. Лицензия Power BI Premium разблокирует доступ к различным функциям, возможностям и типам содержимого, которые доступны только через Premium. Лицензия Premium на пользователя предоставляет доступ к этим функциям только для пользователей с лицензией Premium на пользователя, а лицензия Premium на основе емкости позволяет пользователям с бесплатными лицензиями получать доступ к любому содержимому, при этом только пользователи с лицензией Pro могут создавать содержимое. Пользователь может повысить уровень своей лицензии до Pro или зарегистрировать лицензию Pro напрямую, если в организации используется коммерческое облако. Прямое приобретение лицензий или их повышение до уровня Pro недоступно для учебных заведений или организаций, развернутых в Azure для государственных организаций, Azure для Германии или Azure для Китая (21Vianet).
...
У лицензии Power BI Pro такой же жизненный цикл, как и у подписки Microsoft 365. См. дополнительные сведения о [работе с данными и доступе после истечения срока действия подписки Microsoft 365 для бизнеса](/microsoft-365/commerce/subscriptions/what-if-my-subscription-expires).
...
* Производительность
* Лицензирование "на пользователя" (дополнительные сведения см. в статье [Вопросы и ответы по Power BI Premium на пользователя](service-premium-per-user-faq.md))
* Больший масштаб
* Улучшенные метрики
* Автомасштабирование

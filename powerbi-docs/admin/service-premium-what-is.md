...
В настоящее время Premium 2-го поколения доступен в виде полностью поддерживаемой предварительной версии функции только для номеров SKU **P** и **EM**. Емкость с номером SKU **A** еще не предлагает все дополнительные преимущества, представленные в обновлении предварительной версии Premium 2-го поколения.
...
> [!NOTE]
> В **Premium 2-го поколения (предварительная версия)** управление памятью для отчетов с разбивкой на страницы отсутствует. При использовании Premium 2-го поколения отчеты с разбивкой на страницы поддерживаются в SKU EM1–EM3.

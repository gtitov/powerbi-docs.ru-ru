...
ms.locfileid: "94668219"
---
# <a name="what-is-power-bi-premium"></a>Что такое Power BI Premium?

Вы можете использовать Power BI Premium для доступа к функциям и возможностям, доступным только в версии Premium, и повысить масштаб и производительность для содержимого Power BI в организации. Power BI Premium позволяет большему числу пользователей в организации максимально эффективно использовать Power BI с более высокой производительностью и скоростью реагирования. Например, подписка Power BI Premium обеспечивает вам и пользователям вашей организации следующие преимущества:
...
* Вы можете значительно **снизить расходы на управление** благодаря упреждающим и настраиваемым уведомлениям для администратора об уровне использования емкости и увеличении нагрузки.


### <a name="using-premium-gen2"></a>Использование Premium 2-го поколения

Чтобы воспользоваться преимуществами обновлений, необходимо включить Premium 2-го поколения. Чтобы включить Premium 2-го поколения, выполните следующие действия.
...
2.  Параметры емкости Premium 2-го поколения для конкретных рабочих нагрузок пока не отображаются на странице параметров емкости Premium 2-го поколения на портале администрирования. Чтобы изменить параметры, перенесите емкость в исходную версию Premium, измените параметры, а затем установите емкость для использования Premium 2-го поколения еще раз. Параметры выделения памяти неприменимы для емкости Premium 2-го поколения.

3.  Потоки данных с источниками данных ADLS 2-го поколения в настоящее время не работают в емкости Premium 2-го поколения.  

4.  Если вы используете XMLA в Premium 2-го поколения, убедитесь, что используете последние версии [средств моделирования данных и управления ими](service-premium-connect-tools.md#data-modeling-and-management-tools). 

...
> [!NOTE]
> В **Premium 2-го поколения (предварительная версия)** управление памятью для отчетов с разбивкой на страницы отсутствует. При использовании Premium 2-го поколения отчеты с разбивкой на страницы поддерживаются в SKU EM1–EM3 и A1–A3.
...
За работу с наборами данных и рабочими областями Power BI Premium отвечает хорошо зарекомендовавшая себя корпоративная подсистема Microsoft **Analysis Services Vertical**. Analysis Services обеспечивает программируемость и поддержку клиентских приложений и средств посредством клиентских библиотек и API, поддерживающих основанный на открытых стандартах протокол XMLA. По умолчанию рабочие нагрузки наборов данных емкости Power BI Premium поддерживают операции *только для чтения* со стороны клиентских приложений и средств Майкрософт и других производителей через **конечные точки XMLA**. Администраторы емкости также могут отключить или разрешить операции *чтения и записи* через конечную точку.

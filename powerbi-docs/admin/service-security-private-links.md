...
ms.locfileid: "92349444"
---
# <a name="private-links-for-accessing-power-bi"></a>Приватные каналы для доступа к Power BI

Сети Azure предоставляют две функции безопасности: Приватный канал и Частные конечные точки Azure, которые позволяют Power BI обеспечить безопасный доступ. Благодаря Приватным каналам и Частным конечным точкам Azure трафик данных отправляется частным образом с помощью инфраструктуры магистрали корпорации Майкрософт, и поэтому данные не проходят через Интернет. 

...
>[!NOTE]
>В течение первых 48 часов после включения предварительной версии функции Information Protection в Power BI Desktop **могут возникнуть проблемы с PBIX-файлами, к которым применены метки конфиденциальности (например, с публикацией PBIX-файлов в службе или скачиванием их из службы)** . Такие проблемы ожидаемы и будут автоматически устранены в течение 48 часов.

...
Пользователи в организации могут добавлять и просматривать плитки веб-содержимого на панелях мониторинга Power BI. [Подробнее](../create-reports/service-dashboard-add-widget.md)

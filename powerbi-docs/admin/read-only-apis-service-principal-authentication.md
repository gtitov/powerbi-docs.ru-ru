...
ms.locfileid: "96506753"
---
# <a name="enable-service-principle-authentication-for-read-only-admin-apis-preview"></a>Включение аутентификации субъекта-службы для интерфейсов API администрирования с доступом только на чтение (предварительная версия)

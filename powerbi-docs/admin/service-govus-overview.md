...
description: Клиенты из государственных учреждений США могут присоединять подписки Power BI к своим планам Microsoft 365 для государственных организаций. Узнайте, как зарегистрироваться, подключиться и проверить доступность функций, в описании этой службы.
author: kfollis
ms.author: kfollis
ms.reviewer: ''
ms.service: powerbi
...
В соответствии с требованиями клиентов облаков для государственных организаций государственный план отличается от коммерческого. Наша цель заключается в предоставлении доступа ко всем функциям в облаках для государственных организаций в течение 30 дней с момента выхода их общедоступного выпуска. В некоторых случаях базовые зависимости не позволяют сделать функцию доступной. В списке ниже перечислены функции, которые еще не доступны для государственных организаций или которые доступны с ограниченной функциональностью. В списке используется следующий ключ:

|Ключ |Описание|
|-----|------|
|![доступен](../media/yes.png)|Эта функция доступна в среде с любыми исключениями, указанными в сносках.|
|![недоступно](../media/no.png)| Эта функция недоступна в среде, и у нас нет предполагаемого временного интервала времени для ее предоставления.|

Если планируется выпуск для среды, в качестве приблизительного времени доступности мы указываем квартал.

|Признак |GCC |GCC High |DoD|
|------|------|------|------|
|[Совместная работа Azure B2B между государственным и коммерческим облаком](service-admin-azure-ad-b2b.md)<sup>1</sup>|![доступен](../media/yes.png)|![доступен](../media/yes.png)|![доступен](../media/yes.png)
|[Приложения-шаблоны](../connect-data/service-template-apps-overview.md)<sup>2</sup>|![доступен](../media/yes.png) |![доступен](../media/yes.png)| ![доступен](../media/yes.png)|
...
<sup>2</sup> Приложения Marketplace недоступны для экземпляров облака для государственных организаций США, поэтому приложения-шаблоны ограничены частными приложениями и приложениями организации.

<sup>3</sup> Функциональность Power BI в Teams для GCC является ограниченной. Эта возможность поддерживается только для классических рабочих областей и не включает улучшенные функциональные возможности, описанные в статье [Внедрение содержимого Power BI в Microsoft Teams](../collaborate-share/service-embed-report-microsoft-teams.md).

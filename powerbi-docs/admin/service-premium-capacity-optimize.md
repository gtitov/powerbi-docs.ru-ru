...
Рекомендации и лучшие методики в этой статье гарантируют оптимальное использование ЦП для каждого набора данных и других артефактов Power BI.

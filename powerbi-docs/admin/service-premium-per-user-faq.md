...
5.  **Срок действия начальной пробной версии истек, и все еще действует период предварительной версии.  Как продлить пробную версию Premium на пользователя в течение периода предварительной версии?**

    Для клиентов, использующих пробную версию, можно запустить новую пробную версию в любое время после истечения срока действия исходной пробной версии. Для этого щелкните значок профиля в правом верхнем углу портала.  Вы увидите вариант повторного выбора пробной версии.  В этом случае пробная версия будет запущена еще на 60 дней.  Эта возможность будет доступна в течение периода действия предварительной версии.  
    
    Для клиентов, использующих пробную версию, предлагаемую в рамках Microsoft 365, администратор клиента может продлить первоначальную 30-дневную пробную версию еще на 30 дней. Это максимальный период, на который можно продлить пробную версию.

6.  **Какие функции доступны в лицензии Premium на пользователя?**
...
7.  **В моей организации уже есть Power BI Premium. Нужна ли мне лицензия Premium на пользователя для публикации содержимого в моей емкости?**
...
7.  **Поддерживаются ли субъекты-службы в рабочих областях Premium на пользователя?**

    Нет, сейчас субъекты-службы в рабочих областях Premium на пользователя не поддерживаются.  
...
5.  **Что произойдет с рабочей областью Premium на пользователя в конце периода действия предварительной версии, если принято решение не приобретать лицензии Premium на пользователя?**

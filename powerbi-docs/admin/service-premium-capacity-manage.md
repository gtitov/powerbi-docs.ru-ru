...
Для Premium 2-го поколения параметры памяти или обновления не требуются. Все рабочие нагрузки имеют необходимый объем памяти в пределах емкости вашего номера SKU.

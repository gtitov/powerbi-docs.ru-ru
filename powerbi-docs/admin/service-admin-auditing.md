...
| Создание рабочей области приложения-шаблона Power BI | CreateTemplateApp   |
| Создание билета установки приложения-шаблона Power BI | CreateTemplateAppInstallTicket |
| Создание пакета приложения-шаблона Power BI | CreateTemplateAppPackage |
...
| Удалена рабочая область приложения-шаблона Power BI | DeleteTemplateApp |
| Удален пакет приложения-шаблона Power BI | DeleteTemplateAppPackage |
...
| Извлечен пакет приложения-шаблона Power BI в рабочую область | ExtractTemplateAppPackage |
...
| Создание снимка экрана                       | GenerateScreenshot |                     |
| Импортирован файл в Power BI                         | Импорт                                      |                                          |
| Установлено приложение Power BI                            | InstallApp                                  |                                          |
| Установленное приложение-шаблон Power BI | InstallTemplateApp |
...
| Рекомендован пакет приложения-шаблона Power BI | PromoteTemplateAppPackage |
...
| Обновлены параметры установленного приложения-шаблона Power BI | UpdateInstalledTemplateAppParameters |
...
| Обновлены параметры приложения-шаблона Power BI | UpdateTemplateAppSettings |
| Обновлены разрешения на доступ для тестирования приложения-шаблона Power BI | UpdateTemplateAppTestPackagePermissions |

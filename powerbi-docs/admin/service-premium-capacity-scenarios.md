...
> [!NOTE]
> Для уровня Premium 2-го поколения потребление памяти не требует отслеживания. Единственным ограничением в Premium 2-го поколения является занимаемая память одного артефакта. Занимаемая память не может превышать объем доступной памяти. Дополнительные сведения см. в разделе о [емкости Power BI Premium 2-го поколения (предварительная версия)](service-premium-what-is.md#power-bi-premium-generation-2-preview).
...
> [!NOTE]
> Для Premium 2-го поколения использование времени ЦП отслеживается на уровне артефактов и отображается в приложении "Использование емкости". Для каждого артефакта показано общее использование времени ЦП в заданном промежутке. Дополнительные сведения см. в разделе о [емкости Power BI Premium 2-го поколения (предварительная версия)](service-premium-what-is.md#power-bi-premium-generation-2-preview).

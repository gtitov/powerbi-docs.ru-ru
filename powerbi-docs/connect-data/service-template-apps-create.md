...
Если вы создаете отчеты и панели мониторинга Power BI, то можете стать *автором приложений-шаблонов*, который создает и упаковывает в *приложение* различное аналитическое содержимое. Затем готовое приложение можно развернуть в других клиентах Power BI с помощью любой доступной платформы, например в AppSource или в вашей собственной веб-службе. Если вы распространяете приложение-шаблон с помощью собственной веб-службы, можно даже [автоматизировать процесс установки](../developer/template-apps/template-apps-auto-install.md), чтобы упростить работу клиентам.
...
6. Выберите **Перейти к приложению**.
    ...
    Убедитесь, что в тестовом приложении есть образец данных. Чтобы внести изменения, вернитесь к приложению в исходной рабочей области. Изменяйте тестовое приложение, пока вас не будет все устраивать.

1. Когда вы будете готовы повысить уровень приложения до предварительного для дальнейшего тестирования вне клиента, вернитесь в область **Управление выпусками** и щелкните **Повысить уровень приложения**.

...
![Снимок экрана: пункт Excel](media/desktop-connect-excel/connect_to_excel_1.png)

Выберите книгу в диалоговом окне **Открыть**.
![Снимок экрана: диалоговое окно "Открыть"](media/desktop-connect-excel/connect_to_excel_2.png)
...
![Снимок экрана: окно "Навигатор"](media/desktop-connect-excel/connect_to_excel_3.png)
...
![Снимок экрана: окно "Загрузить"](media/desktop-connect-excel/connect_to_excel_4.png)
...
![Снимок экрана: область "Поля"](media/desktop-connect-excel/connect_to_excel_5.png)

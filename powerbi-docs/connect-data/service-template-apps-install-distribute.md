...
## <a name="delete-a-template-app"></a>Удаление приложения-шаблона

Установленное приложение шаблона состоит из приложения и связанной с ним рабочей области. Существует два способа удалить приложение-шаблон:
* **Полное удаление приложения и связанного с ним рабочего пространства**. Чтобы полностью удалить приложение-шаблон и связанную с ним рабочую область, перейдите на плитку приложения на странице "Приложения", щелкните значок корзины, а затем в появившемся диалоговом окне нажмите **Удалить**.
* **Отмена публикации приложения**. В этом случае приложение удаляется, однако связанная с ним рабочая область сохраняется. Этот вариант полезен, если, например, требуется сохранить настроенные параметры.

    Порядок отмены публикации.
    1. Запустите приложение.
    1. Щелкните значок редактирования приложения (значок карандаша), чтобы открыть рабочую область приложения-шаблона.
    1. В рабочей области приложения-шаблона выберите **Дополнительные параметры (...)** , а затем выберите **Отменить публикацию приложения**.

        ![Снимок экрана с параметром отмены публикации приложения.](media/service-template-apps-install-distribute/power-bi-template-app-unpublish.png)

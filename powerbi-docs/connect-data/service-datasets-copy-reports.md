...
- Для копирования отчета вам требуется лицензия Pro, даже если исходный отчет находится в рабочей области в емкости Premium.
- Чтобы скопировать отчет или создать в одной рабочей области отчет на основе набора данных из другой рабочей области, требуется разрешение на создание набора данных. При использовании наборов данных в оригинальной рабочей области пользователям с ролями администратора, члена или участника автоматически предоставляются разрешения на создание в рамках роли рабочей области. Дополнительные сведения см. в разделе [Роли в новых рабочих областях](../collaborate-share/service-new-workspaces.md#roles-in-the-new-workspaces).

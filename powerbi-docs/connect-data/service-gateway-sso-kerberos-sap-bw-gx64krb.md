...
> [!IMPORTANT]
> SAP больше не поддерживает gx64krb5, и в результате корпорация Майкрософт также прекратила поддержку gx64krb5. Существующие и новые подключения продолжат работать должным образом до конца 2020 г., но не будут работать с 1 января 2021 г. Вместо этой библиотеки следует использовать CommonCryptoLib. 

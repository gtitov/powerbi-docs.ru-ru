...
> [!IMPORTANT]
> SAP больше не поддерживает gx64krb5 для локальных шлюзов данных в Power BI. В результате корпорация Майкрософт также прекратила поддержку использования gx64krb5 в этом сценарии. Существующие подключения продолжат работать, но вы не сможете создавать новые подключения для этого сценария начиная с февраля 2021 г. Вместо этой библиотеки следует использовать CommonCryptoLib. 

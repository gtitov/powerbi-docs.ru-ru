...
> [!IMPORTANT]
> Многократного использования данных можно достичь с помощью [общих наборов данных](../connect-data/service-datasets-share.md), которые при необходимости можно [сертифицировать](../collaborate-share/service-endorse-content.md) для подтверждения надежности и улучшения возможности обнаружения. [Потоки данных](../transform-model/dataflows/dataflows-introduction-self-service.md) позволяют сократить повторяющуюся логику подготовки данных в нескольких наборах данных. Потоки данных также могут значительно снизить нагрузку на исходные системы, так как данные извлекаются реже — несколько наборов данных затем могут импортировать данные из потока данных.

...
ms.locfileid: "94396985"
---
# <a name="plan-deployment-to-migrate-to-power-bi"></a>Планирование развертывания для миграции в Power BI
...
- Будет ли полезным создание [потока данных](../transform-model/dataflows/dataflows-introduction-self-service.md), и может ли он служить источником для множества наборов данных?

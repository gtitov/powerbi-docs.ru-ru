...
| Руководство | Описание |
| --- | --- |
| [Рекомендации по потокам данных](../transform-model/dataflows/dataflows-introduction-self-service.md) | Здесь приводятся рекомендации по проектированию потоков данных в Power BI. |

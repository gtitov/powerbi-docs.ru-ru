...
![холст отчета в режиме правки](media/service-tips-and-tricks-for-color-formatting/power-bi-edit-filter.png)
...
![Значок переключения темы в строке меню](media/service-tips-and-tricks-for-color-formatting/power-bi-themes.png)
...
![Изменение цветов данных на серый](media/service-tips-and-tricks-for-color-formatting/power-bi-format.png)
...
![Панель форматирования с включенным параметром "Показать все"](media/service-tips-and-tricks-for-color-formatting/power-bi-show-all.png)
...
Для изменения цвета в соответствии со значением выберите визуализацию, чтобы сделать ее активной. Откройте область форматирования, щелкнув значок валика и выбрав карточку **Цвета данных**. Под пунктом **Цвет по умолчанию** нажмите на значок fx.  

![Выберите параметр условного форматирования, щелкнув три вертикальные точки](media/service-tips-and-tricks-for-color-formatting/power-bi-conditional.png)

...
Давайте добавим метки данных к диаграмме с областями. 
...
## <a name="adding-total-labels"></a>Добавление меток итогов    

Последний пример форматирования, прежде чем вы приступите к собственным примерам.  Давайте добавим метки итогов в гистограмму с накоплением. Метки итогов доступны для диаграмм с накоплением, комбинированных диаграмм и диаграмм с областями.

При включении меток итогов в Power BI отображает агрегированное или итоговое значение данных. Давайте рассмотрим пример. 

У нас есть гистограмма с накоплением с метками данных, отображающими значение каждой части каждого полного стека.  Это представление используется по умолчанию. 

![гистограмма с метками данных](media/service-getting-started-with-color-formatting-and-axis-properties/power-bi-column-charts.png)


Открыв визуальный элемент в режиме правки, можно изменить отображение меток данных и меток итогов. Выберите визуализацию, чтобы сделать ее активной, и откройте панель "Форматирование". Прокрутите вниз до параметров **Метки данных** и **Метки итогов**. **Метки данных** включены, а **Метки итогов** отключены. 

![неформатированная гистограмма](media/service-getting-started-with-color-formatting-and-axis-properties/power-bi-total-label.png)

Отключите **Метки данных** и включите **Метки итогов**. Теперь в Power BI отображается агрегированное значение для каждого столбца.    
![форматированная гистограмма](media/service-getting-started-with-color-formatting-and-axis-properties/power-bi-totals.png)

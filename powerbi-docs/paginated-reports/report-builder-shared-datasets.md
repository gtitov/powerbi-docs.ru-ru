...
- Если вы хотите использовать набор данных Power BI, использующий DirectQuery в построителе отчетов Power BI, набор данных должен включать меру, даже если вы не планируете отображать меру в отчете. Без меры набор данных не возвращает правильные результаты.

...
:::image type="content" source="media/power-bi-custom-visuals/power-bi-visualizations.png" alt-text="Снимок экрана области визуализации Power BI, отображаемой в Power BI Desktop и службе Power BI.":::

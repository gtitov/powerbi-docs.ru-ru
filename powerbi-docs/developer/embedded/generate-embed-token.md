---
title: Рекомендации по созданию токена внедрения во встроенной аналитике Power BI для более эффективного использования встроенной бизнес-аналитики Power BI
description: Сведения о рекомендациях, ограничениях и необходимых разрешениях для создания токена внедрения. Получайте оптимальную встроенную бизнес-аналитику в Power BI.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
...
>[!div class="nextstepaction"]
>[Внедрение содержимого Power BI с помощью субъект-службы](embed-service-principal.md)
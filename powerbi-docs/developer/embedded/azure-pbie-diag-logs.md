---
title: Ведение журнала диагностики для службы Power BI Embedded в Azure для решения встроенной бизнес-аналитики Power BI
description: Сведения о ведении журнала диагностики для службы Power BI Embedded в Azure для решения встроенной бизнес-аналитики Power BI.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi

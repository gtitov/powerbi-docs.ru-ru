...
### <a name="what-is-the-pbi-embedded-capacity-role-in-a-pbi-embedded-solution"></a>Что такое роль емкости PBI Embedded в решении PBI Embedded?

Чтобы [повысить уровень решения до рабочей среды](move-to-production.md), нужно назначить содержимое Power BI (рабочую область), используемое вашим приложением, емкости Power BI Embedded (SKU А).
...
**[Идентификатор приложения](embed-sample-for-customers.md#client-id)** , также называемый *идентификатором клиента*, используется для создания маркера доступа при передаче этого идентификатора для проверки подлинности.
...
3. Когда вы будете готовы перейти в рабочую среду, приобретите емкость **Power BI Embedded** и назначьте ей определенное содержимое (рабочую область) Power BI.
...
[Средство настройки внедрения](https://app.powerbi.com/embedsetup) позволяет быстро приступить к работе и скачать образец приложения, чтобы начать внедрение в Power BI.

### <a name="which-solution-should-i-choose"></a>Какое решение выбрать?

* [Внедрение для клиентов](embedding.md#embedding-for-your-customers) позволяет внедрять панели мониторинга и отчеты для пользователей, у которых нет учетной записи Power BI. В [средстве настройки внедрения](https://app.powerbi.com/embedsetup) запустите решение *Внедрение для клиентов*.
* [Внедрение для организации](embedding.md#embedding-for-your-organization) позволяет расширить возможности службы Power BI. В [средстве настройки внедрения](https://app.powerbi.com/embedsetup) запустите решение *Внедрение для организации*.

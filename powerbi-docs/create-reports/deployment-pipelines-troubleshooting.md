...
Для использования конвейеров развертывания необходимо иметь одну из следующих лицензий:

* Лицензия [Pro](../admin/service-admin-purchasing-power-bi-pro.md) с рабочей областью, находящейся в [емкости Premium](../admin/service-premium-what-is.md).

* [Premium на пользователя (PPU)](../admin/service-premium-per-user-faq.md).

Дополнительные сведения см. в разделе [Доступ к конвейерам развертывания](deployment-pipelines-get-started.md#accessing-deployment-pipelines).
...
Чтобы конвейер развертывания был работоспособным, все рабочие области в нем должны находиться в пределах емкости. Однако можно использовать разные емкости для разных рабочих областей в конвейере. Кроме того, можно использовать различные типы емкости для разных рабочих областей в одном конвейере.

Для разработки и тестирования можно использовать емкость A или EM в качестве учетной записи Power BI Pro для каждого пользователя. Вы также можете использовать PPU для каждого пользователя на этапах разработки и тестирования.

Для рабочих областей требуется емкость P. Если вы являетесь независимым поставщиком программного обеспечения, распространяющим содержимое через встраиваемые приложения, вы также можете использовать для производства емкости A или EM. PPU также можно использовать в рабочих областях.

>[!NOTE]
>При создании рабочей области с помощью PPU только другие пользователи PPU смогут получить доступ к рабочей области и использовать ее содержимое.
...
* **Развертывание на пустом этапе** может выполнить любой пользователь [Pro](../admin/service-admin-purchasing-power-bi-pro.md) или [PPU](../admin/service-premium-per-user-faq.md), который является участником или администратором в исходной рабочей области.

* **Развертывание на этапе с содержимым** может выполнить любой пользователь [Pro](../admin/service-admin-purchasing-power-bi-pro.md) или [PPU](../admin/service-premium-per-user-faq.md), который является участником обеих рабочих областей на исходном и целевом этапах развертывания.

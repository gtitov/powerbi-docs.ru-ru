...
| Фильтрация |Нет. Нельзя выполнить фильтрацию или срез панели мониторинга. *Можно* выполнить фильтрацию [плитки панели мониторинга в режиме фокусировки](../consumer/end-user-focus.md#working-in-focus-mode), но нельзя сохранить фильтр. |Да. Множество различных способов для выполнения фильтрации, выделения и среза |

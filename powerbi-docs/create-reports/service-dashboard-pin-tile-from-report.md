...
Некоторые параметры форматирования отчета или темы не применяются к визуальным элементам при их закреплении на панели мониторинга.
- Параметры границы, тени и фона будут игнорироваться в закрепленной плитке.
- На панелях мониторинга для указания значений в визуальных элементах карточки используется шрифт семейства DIN с текстом черного цвета. Цвет текста для всех плиток на панели мониторинга можно изменить, [создав настраиваемую тему панели мониторинга](service-dashboard-themes.md).
- Условное форматирование не применяется.
- Размер визуальных элементов корректируется в соответствии с размером плитки. Это может привести к различиям в макете, как при изменении размера визуального элемента в отчете.

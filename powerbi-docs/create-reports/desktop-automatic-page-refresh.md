...
Автоматическое обновление страниц доступно только для [источников DirectQuery](../connect-data/desktop-directquery-about.md) и некоторых сценариев LiveConnect, поэтому оно будет доступно только при подключении к поддерживаемому источнику данных. Это ограничение распространяется на оба типа автоматического обновления страниц.
...
В службе Power BI ограничения на автоматическое обновление страниц применяются на основе рабочей области, в которой опубликован отчет, факта использования служб уровня "Премиум", а также на основе параметров администратора емкостей Premium и типа источника данных.
...
| Analysis Services (Azure и локальная среда)     | **Поддерживается ФИ**: Да <br>**Поддерживается ОИ**: Нет <br>**Минимум**: 30 мин <br>**Переопределение администратором** : Да | **Поддерживается ФИ**: Да <br>**Поддерживается ОИ**: Нет <br>**Минимум**: 30 мин <br>**Переопределение администратором** : Нет |
| Наборы данных Power BI (с источником DirectQuery)   | **Поддерживается ФИ**: Да <br>**Поддерживается ОИ**: Нет <br>**Минимум**: 1 секунда <br>**Переопределение администратором** : Да  | **Поддерживается ФИ**: Да <br>**Поддерживается ОИ**: Нет <br>**Минимум**: 30 мин <br>**Переопределение администратором** : Нет |
| Наборы данных push-уведомлений Power BI                        | **Поддерживается ФИ**: Да <br>**Поддерживается ОИ**: Нет <br>**Минимум**: 30 мин <br>**Переопределение администратором** : Да | **Поддерживается ФИ**: Да <br>**Поддерживается ОИ**: Нет <br>**Минимум**: 30 мин <br>**Переопределение администратором** : Нет        |
...
> [!WARNING]
> Нам известно о проблеме при подключении из Power BI Desktop к Analysis Services или наборам данных Power BI, когда интервал обновления равен 30 минутам или более. По истечении 30 минут для визуальных элементов на странице отчета может отображаться сообщение об ошибке.
...
* Режим хранения для импорта не поддерживается при автоматическом обновлении страниц.  

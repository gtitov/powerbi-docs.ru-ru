...
## <a name="apply-filters-button"></a>Кнопка применения фильтров
...
### <a name="turn-on-the-apply-button"></a>Включение кнопки "Применить"
...
1. Выберите **Добавление на панель фильтра одной кнопки "Применить" для применения всех изменений сразу**.
    ...
    :::image type="content" source="media/power-bi-report-filter/apply-all-filters.png" alt-text="Включение кнопки применения фильтров":::

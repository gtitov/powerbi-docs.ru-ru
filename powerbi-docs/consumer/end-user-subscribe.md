...
Чтобы **создать** подписку для себя, требуется лицензия *Power BI Pro* или [лицензия](end-user-license.md) *"Премиум" для каждого пользователя*. Вы также можете создать подписку для себя, если отчет или панель мониторинга находятся в рабочей области "Премиум", а вам предоставлен доступ к этой рабочей области. Если не удается создать подписку, обратитесь к администратору Power BI или в службу технической поддержки. 

Создавать **подписки для других пользователей** могут только владельцы панелей мониторинга или отчетов с лицензией *Power BI Pro*.

**Подписка на отчет с разбивкой на страницы** немного отличается. Дополнительные сведения см. в статье [Создание подписки на отчет с разбивкой на страницы в службе Power BI для себя и других пользователей](paginated-reports-subscriptions.md). 
...
![выбор значка подписки](./media/end-user-subscribe/power-bi-subscribes.png).
...
1. Выберите **Добавить новую подписку**.
   ...
   ![Окно подписки](./media/end-user-subscribe/power-bi-email-numbered.png)
    
    Экран слева появляется, когда вы находитесь в отчете и выбираете **Подписаться**. Экран справа появляется, когда вы находитесь на панели мониторинга и выбираете **Подписаться**. 
    
    а. Чтобы подписываться на несколько страниц в отчете, выберите **Добавить новую подписку** и выберите другую страницу в раскрывающемся списке вверху или установите флажок **Full report attachment as** (Вложение полного отчета как) в разделе **Также включить**. 
    ...
    c. Добавьте по крайней мере один адрес электронной почты и, при необходимости, сведения о теме и сообщении электронной почты. 
    ...
    ж. Установите один или несколько флажков.
    - Предоставьте получателям разрешение на открытие и просмотр отчета или панели мониторинга.
    - Выберите **Перейдите к отчету (панели мониторинга)** , чтобы добавить ссылку "Перейти к отчету" в тексте сообщения электронной почты.
    - Добавьте в текст сообщения электронной почты эскиз страницы отчета для предварительного просмотра.
    - Вложите не только одну страницу отчета, а весь отчет и выберите PDF или PowerPoint. Размер вложения не должен превышать 20 страниц и 25 МБ. Для вложения учитываются все метки конфиденциальности, применяемые к отчету. 
    
    h. Чтобы просмотреть и протестировать подписку, нажмите **Запустить сейчас**.  Вам немедленно будет отправлено сообщение электронной почты. 
...
3. Если всё в порядке, сохраните подписку, нажав **Сохранить и закрыть**. Вы получите сообщение электронной почты и моментальный снимок панели мониторинга или отчет по заданному расписанию. Все подписки, для которых задана частота **После обновления данных**, будут отправлять сообщение только после первого запланированного обновления в этот день.
   ...
   ![Отправка по электронной почте моментального снимка панели мониторинга](media/end-user-subscribe/power-bi-subscriptions-email.png)
   
    Страницу отчета можно обновить, а набор данных нет. Только владелец набора данных может вручную обновить набор данных. Чтобы найти имя владельца для базовых наборов данных, откройте отчет и щелкните раскрывающийся список в строке меню.
...
![просмотр всех подписок в своей рабочей области](./media/end-user-subscribe/power-bi-manage-subscription.png)
...
* Если вы не можете использовать функцию подписки, обратитесь к системному администратору или в службу технической поддержки. Возможно, ваша организация отключила эту функцию или достигнуто максимальное число подписчиков.  
...
* Функция вложения полного отчета доступна для отчетов, отвечающих следующим трем условиям. Все существующие подписки с полными отчетами в виде вложений, не соответствующие этим условиям, будут отключены, и вы получите сообщение электронной почты с объяснением этой ошибки.

...
## <a name="investigate-anomalies-in-time-series-data"></a>Исследование аномалий в данных временных рядов

[Обнаружение аномалий](https://powerbi.microsoft.com/blog/anomaly-detection-preview/) — это функция Power BI, которая автоматически обнаруживает аномалии (т. е. значения, которые находятся за пределами ожидаемых диапазонов) на графиках с данными временных рядов. Кроме того, она предоставляет объяснения возможных причин аномальных значений, ранжированные в соответствии с их достоверностью. Обнаружение аномалий доступно, если оно включено на диаграмме создателем отчета. 

При просмотре отчета с включенным обнаружением аномалий на диаграмме с данными временных рядов аномалии отображаются так же, как в службе Power BI и приложении Power BI Desktop. 

![Снимок экрана с графиком, на котором обозначены аномалии.](media/mobile-reports-in-the-mobile-apps/mobile-detected-anomalies.png)

Чтобы просмотреть дополнительные сведения и объяснения, необходимо открыть панель аномалий. Это можно сделать несколькими способами.
* Коснитесь индикации аномалий на диаграмме. 
* Коснитесь элемента **Дополнительные параметры (...)** и в появившемся меню выберите **Show anomalies** (Показывать аномалии).    
* Коснитесь точки данных, чтобы отобразить подсказку, и выберите **Anomalies** (Аномалии).

На рисунке ниже показаны три способа открытия панели аномалий.

![Снимки экрана, на которых показано, как открыть панель аномалий.](media/mobile-reports-in-the-mobile-apps/mobile-opening-anomalies-panel.png)

На панели аномалий отображается объяснение обнаруженной аномалии на естественном языке, а также связанные с ним факторы, отсортированные по достоверности построенного на их основе объяснения. Проведите пальцем справа налево, чтобы просмотреть все соответствующие факторы и их достоверность.

![Снимок экрана с прокруткой справа налево для просмотра объяснений аномалий.](media/mobile-reports-in-the-mobile-apps/mobile-swipe-to-see-explanations.png)

При отображении панели аномалий под ней можно прокручивать мобильную версию отчета. Благодаря этому вы можете продолжать взаимодействовать с отчетом и анализировать его, чтобы лучше понять аномалии в данных. При каждом взаимодействии Power BI запускает обнаружение аномалий повторно, чтобы обнаружить аномалии в данных в области. 

...
3. Коснуться значка **Развернуть плитку** ![значок "Развернуть плитку"](media/mobile-tiles-in-the-mobile-apps/power-bi-windows-10-focus-mode-icon.png). Она откроется в режиме фокусировки, в котором проще просматривать и изучать представленные на ней данные. В этом режиме можно выполнять следующие задачи.
   ...
   *На этой линейчатой диаграмме значения столбца **Decor** (Декор) показаны над диаграммой.*
   ...
   Коснитесь значка **Переключиться в режим презентации** ![Изображение значка "Переключиться в режим презентации".](media/mobile-tiles-in-the-mobile-apps/power-bi-full-screen-icon.png) , чтобы открыть плитку в режиме презентации без панелей навигации и меню.
   
   > [!NOTE]
   > Вы также можете [просматривать панели мониторинга и отчеты в режиме презентации](mobile-windows-10-app-presentation-mode.md) в мобильном приложении Power BI для Windows 10.
   > 
   > 

...
Для экспорта данных требуется лицензия Power BI Pro. Она также требуется для предоставления общего доступа к панели мониторинга или отчету с использованием емкости Premium. Дополнительные сведения см. в разделе [Типы лицензий Power BI](end-user-license.md). Автор отчета мог отключить экспорт данных для отчета. Если экспорт данных невозможен, обратитесь к автору отчета.
...
4. Вы увидите параметры экспорта сводных или базовых данных. Если вы используете пример приложения для *маркетинга и продаж* , вариант **Базовые данные** будет отключен. Но можно найти отчеты, в которых включены оба варианта. Ниже приведено объяснение различий.

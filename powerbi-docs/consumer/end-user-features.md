...
- получает содержимое (приложения, панели мониторинга, отчеты) от пользователей Pro, которые предоставляют общий доступ к этому содержимому с помощью рабочих областей приложений в емкости Premium;

...
**assign**   (назначить)  
[Power BI Premium]. Команда для перемещения рабочей области в емкость или из нее. Не используйте повышение уровня для перемещения рабочей области в емкость, так как предполагается, что выделенная емкость имеет приоритет над общей. 

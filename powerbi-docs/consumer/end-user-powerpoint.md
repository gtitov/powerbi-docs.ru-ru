...
* Некоторые отчеты невозможно экспортировать. К ним относятся следующие объекты.
    ...
    - Отчеты, содержащие более 50 страниц. На отчеты с разбивкой на страницы это ограничение не распространяется. Подробные сведения см. в разделе [Печать отчета с разбивкой на страницы](end-user-paginated-report.md#interact-with-a-paginated-report).

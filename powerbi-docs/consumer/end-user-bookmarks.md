...
Предоставьте общий доступ к отчету, добавленного в закладки, коллегам, которые также имеют доступ на чтение отчета. Представление отчета, сохраненного в закладках, не переопределяет исходный отчет в конструкторе.  Для предоставления доступа коллегам, у которых еще нет доступа на чтение, требуются разрешения на повторное предоставление общего доступа. Если не удается поделиться представлением отчета, обратитесь к владельцу отчета, чтобы запросить разрешение на повторное предоставление общего доступа.  
...
:::image type="content" source="media/end-user-bookmarks/power-bi-personalize-share-changes.png" alt-text="Общий доступ к изменениям":::
...
:::image type="content" source="media/end-user-bookmarks/power-bi-personalize-reset-all.png" alt-text="Сброс всех изменений":::
...
* Большинство настраиваемых визуальных элементов Power BI должны нормально работать с использованием закладок. Если у вас возникли трудности при использовании закладок и настраиваемого визуального элемента Power BI, обратитесь к его разработчику с просьбой добавить поддержку закладок.    
...
[Персонализация визуальных элементов в отчете](end-user-personalize-visuals.md)
